	...
	<!-- daypilot libraries -->
        ...
        <style type="text/css">
            ...
            .scheduler_default_rowheadercol2 .scheduler_default_rowheader_inner
            {
                ...
                border-left: 5px solid  #cc0000; /* green */
                border-right: 0px none;
            }
            .status_booked.scheduler_default_rowheadercol2 .scheduler_default_rowheader_inner
            {
                border-left: 5px solid #38761d; /* red */
            }
...
<div id="header1">
            ...
            <div class="main">
                ...
                <div style="width:220px; float:left;margin-left: 7px;">
                    <div id="nav"></div>
                </div>
                ...
                <script type="text/javascript">
                    ...
                    $("#add-table").click(function(ev) {
                        ev.preventDefault();
                        var modal = new DayPilot.Modal();
                        modal.onClosed = function(args) {
                            loadResources();
                        };
                        modal.showUrl("table_new.php");
                    });
                </script>
                ...
                <script>
                    ...
                    dp.rowHeaderColumns = [
                        {title: "Table", display: "name", width: 80},
                    ...
                    dp.onBeforeResHeaderRender = function(args) {
                        var seats = function(count) {
                            return count + " seat" + (count > 1 ? "s" : "");
                        };

                        args.resource.columns[1].html = seats(args.resource.capacity);
                        ...
                        args.resource.areas = [{
                                    ...
                                    js: function(r) {
                                        ...
                                        modal.showUrl("table_edit.php?id=" + r.id);
                                    },
                                    v:"Hover",
                                    css:"icon icon-edit",
                                }];
